...
public final class FeederConstants {
    ...
    // --- INDEXER SPEEDS (RPM) ---
    public static final double kIndexerFeedRPM = 4500.0;     // Shooter'a besleme hızı
    ...
    // --- KICKER SPEEDS (RPM) ---
    public static final double kKickerFeedRPM = 4500.0;      // Shooter'a fırlatma hızı
